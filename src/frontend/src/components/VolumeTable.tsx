...
function computeStatusFromSchedule(
  ...
  for (const seg of todaySegments) {
    ...
    for (const win of windows) {
      ...
      // "HH:MM - 00:00" = from start to end-of-day (00:00 means midnight = 1440)
      // "-"             = all day
      ...
      if (parts.length === 2) {
        ...
        // "00:00" as an end time means end-of-day (midnight = 1440), not start-of-day (0).
        // e.g. "Mon 08:00 - 00:00" means open from 08:00 through midnight.
        endMin = parts[1] && rawEnd === 0 ? 1440 : rawEnd;
      } else if (parts.length === 1 && parts[0]) {
        // Single time token — treat as open from that time through end of day
